...
{Schreiben Sie eine rekursive Prozedur BerechneTiefeUndMaxTiefe, mit der die Tiefe jedes Knotens
*  in einem gegebenen binären Baum ermittelt und dieser Wert der Recordkomponente Tiefe zugewiesen wird. 
  ...
  { berechnet die Tiefe aller Knoten in einem Binaerbaum, auf
   ...
   begin
      ...
      begin
         ...
         MaxTiefe:=inTiefe;
         if ioMaxtiefe < MaxTiefe then
            ioMaxtiefe:=MaxTiefe;
      end
      else  {Baum durchwandern und Tiefe festlegen}
      begin
