...
%  num_labels, ... X, y, lambda) computes the cost and gradient 
%  of the neural network. 
%  The parameters for the neural network are "unrolled" 
%  into the vector nn_params and need to be converted back into 
%  the weight matrices. 
...
% the following parts.
%
% Part 1: Feedforward the neural network and return the cost in 
%   the variable J. After implementing Part 1, you can verify 
%   that your cost function computation is correct by verifying 
%   the cost computed in ex4.m
%
% Part 2: Implement the backpropagation algorithm to compute the 
%   gradients Theta1_grad and Theta2_grad. You should return the %   partial derivatives of the cost function with respect to 
%   Theta1 and Theta2 in Theta1_grad and Theta2_grad, 
%   respectively. After implementing Part 2, you can check that 
...
%   for-loop over the training examples if you are implementing 
%   it for the first time.
%
% Part 3: Implement regularization with the cost function and 
%   gradients.
%
% Hint: You can implement this around the code for back-
%   propagation. That is, you can compute the gradients for
...
% a1=X
a2 = sigmoid(Theta1*X');
a2 = [ones(m,1) a2'];   % adds bias

h_theta=sigmoid(Theta2*a2'); % h_theta = z3
...
% For the matrices Theta1 and Theta2, this corresponds to the 
...
% Ab hier nicht meins, Hilfe geholt...
